      ...
      <div class="row">
         <div class="bd-example">
            <c:if test="${error!=null}">
               <div class="mb-3">
                    <input type="text" class="form-control is-invalid" id="floatingInputInvalid" placeholder="${error}" value="${error}" readonly="true" />
                    </div>
                 </c:if>
            <c:if test="${logout!=null}">
               <div class="mb-3">
                    <input type="text" class="form-control is-invalid" id="floatingInputInvalid" placeholder="${logout}" value="${logout}" readonly="true" />
                    </div>
                 </c:if>
            <div class="mb-3">
