	...
	<form action="/login" method="post">
		<div class="row">
			...
			<c:if test="${error!=null}">
				<div class="mb-3">
	              <input type="text" class="form-control is-invalid"  placeholder="${error}" value="${error}" readonly="ture">
	            </div>
			</c:if>
			<c:if test="${logout!=null}">
				<div class="mb-3">
	              <input type="text" class="form-control is-invalid"  placeholder="${logout}" value="${logout}" readonly="ture">
	            </div>
			</c:if>
				<div class="mb-3">
