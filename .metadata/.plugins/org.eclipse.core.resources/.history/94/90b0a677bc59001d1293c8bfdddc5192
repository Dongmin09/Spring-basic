...
public class BoardController {
    /* @RequestMapping의 value 속성에 요청 경로를 설정
     	...
     	- 속성이 하나일 때는 속성명을 생략할 수 있음(골뱅이RequestMapping(value = "/board/register")
	...
	// ...
	//// 요청URI  : http://localhost/board/read?boardId=1022 => 102번글
...
//		return mav;
	...
	/* 3. Http 메서드 매핑
	 	...
	 	화면으로 응답하는 경우 HTTP 메서드로 GET 방식과 POST 방식 두가지를 사용함
	 */
